...
syn keyword ttcnFunc    hex2oct hex2str oct2int oct2bit oct2str 
syn keyword ttcnFunc    str2int str2float int2str float2str oct2int int2oct
syn keyword ttcnFunc    hex2int int2hex float2int int2float bit2hex hex2bit
syn keyword ttcnFunc    bit2oct oct2bit bit2int int2bit
